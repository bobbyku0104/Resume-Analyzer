...
const Home = () => {
  ...
  return (
    ...
    <div
      className="min-h-screen w-full overflow-x-hidden relative bg-[linear-gradient(120deg,#020617,#1E293B,#312E81,#4C1D95,#701A75)]"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 max-w-6xl w-full">
          <div className="w-full lg:w-1/2 backdrop-blur-xl p-6 lg:p-8 rounded-2xl shadow-xl text-center lg:text-left border border-white/20 bg-white/5">
            ...
            <p className="mt-4 text-white/80 text-base md:text-lg">
              Get AI-powered resume feedback and track applications in one
              place.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <button
                button
                onClick={openForm}
                className="px-6 py-3 bg-white text-indigo-700 font-semibold rounded-xl shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
              >
                <span>📤</span>
                Upload Resume
              </button>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="backdrop-blur-xl p-4 rounded-xl border border-white/20 bg-white/5 text-center hover:scale-105 transition-all duration-300">
              ...
              <p className="text-white/70 text-xs">
                Get matched with perfect job opportunities
              </p>
            </div>
