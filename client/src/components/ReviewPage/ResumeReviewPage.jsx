      ...
      <div className="w-full lg:w-2/3 bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 overflow-y-auto border border-white/60 max-h-screen">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:border-gray-300">
      ...
      <div className="w-full lg:w-1/3 flex justify-center items-center">
        {file ? (
          ...
          <div className="text-center p-8 text-gray-500">
            ...
            <p className="text-lg font-medium mb-2">Resume Preview Placeholder</p>
